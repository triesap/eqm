...
| `step_076` | complete | One sorted registry owns every currently emitted diagnostic exactly once (currently workspace preparation EQM-E0100 and graph/finalization EQM-E0300 through EQM-E0305), supplies title, authority, explanation, and remediation to emission, SARIF, and explain lookup, rejects unregistered codes, validates descriptor completeness, and proves every registry entry is live |
